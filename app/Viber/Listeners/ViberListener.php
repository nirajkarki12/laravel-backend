        ...
        switch (true) {
            ...
            default:{
              switch ($message) {
                case 'about-the-show':
                  $reply = array(
                      'text' => 'The Leader <br/> It is a reality TV show that features the members of the public. It aims to give a particular country a leader that has the vision, zeal and potential to change the country. The leader who can drive the nation and take it forward.<br/> The original concept of the program is to find energetic and dynamic leader who will lead the country in the near future. The best part about this show is that as an individual, you will realize that it is possible to change your country.<br/> To know more please visit the link below.',
